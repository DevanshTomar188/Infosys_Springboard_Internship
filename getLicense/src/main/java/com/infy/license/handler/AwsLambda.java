package com.infy.license.handler;
...
import com.infy.license.LicenseApplication;
...
public class AwsLambda implements RequestStreamHandler {
    ...
    static {
        try {
            handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(LicenseApplication.class);
